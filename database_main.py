...
c.execute('''CREATE TABLE WeiboAccountGroup
       (ID INTEGER PRIMARY KEY AUTOINCREMENT,
...
# cmd = "INSERT INTO WeiboCookies VALUES(NULL, \'"+ "135588610850" +"\', \'"+ "75CEDF6394100000" +"\', \"\", \"\", \"\");"
# cmd = "ALTER TABLE WeiboCookies ADD COLUMN GROUPID INT(20)"
